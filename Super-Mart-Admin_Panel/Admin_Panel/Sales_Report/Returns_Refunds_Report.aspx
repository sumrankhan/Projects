<%@ Page Language="C#" AutoEventWireup="true" Codefile="Returns_Refunds_Report.aspx.cs" Inherits="Admin_Panel.Sales_Report.Returns_Refunds_Report" %>
          ...
          <div class="category-report-container">
            ...
            <div class="category-chart-section">
              <div class="category-chart-container">
                <div id="monthly-refund-chart"></div>
              </div>
            </div>

            <div class="top-product-location-div">
              <div>
                <p class="font-weight-600">Most Returned Item:</p>
                <h2>Wireless Earbuds</h2>
              </div>

              <div class="align-right">
                <p class="font-weight-600">Common Cause Of Return:</p>
                <h2>Defective</h2>
              </div>
            </div>
            ...
            <asp:Repeater ID="salesReportRepeater" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%# Eval("SaleDate", "{0:yyyy-MM-dd}") %></td>
